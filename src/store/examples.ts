export default [
    ...
    {
        "name": "Mount",
        "code": "mount: <div>Hello World!</div>, '#App';\n\n/* Or Use mount api:\n\nimport { mount } from 'alins';\nmount(<div>Hello World!</div>, '#App');\n*/",
        "title": "Rules",
        "iframe": false
    },
    {
